#ifndef GAZEBO_JOINT_CONTROL_JOINTCONTROLLER_H
#define GAZEBO_JOINT_CONTROL_JOINTCONTROLLER_H
/**
...
/**
 * \brief Adapter for gazebo::physics::JointController which adds thread safety.
 *
...
#endif  //  GAZEBO_JOINT_CONTROL_JOINTCONTROLLER_H
